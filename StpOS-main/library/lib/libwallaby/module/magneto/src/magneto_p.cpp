 ...
 */
float kipr::magneto::magneto_x()
{
    return local_magneto_x();
}

/*
 * Returns the magneto_y in the NED frame. +y is right (East). -y is left (West).
 */
float kipr::magneto::magneto_y()
{
    return local_magneto_y();
}

/*
 * Returns the magneto_z in the NED frame. +z is up. -z is down.
 */
float kipr::magneto::magneto_z()
{
    return -local_magneto_z();
}
